...
| DV-002 | 주기 선택 | 데이터 주기 선택 | 선택 | 월간(M) | 일간(D), 월간(M), 분기(Q), 연간(A) | 드롭다운 |
| DV-003 | 새로고침 | 대시보드 데이터 새로고침 | 클릭 | - | - | 버튼 |
| DV-004 | 자동 새로고침 | 설정된 간격으로 자동 새로고침 | 선택 | 비활성화 | - | 토글, 드롭다운 |
| DV-005 | 공유 | 대시보드 공유 기능 | 클릭 | - | - | 버튼, 모달 |
| DV-006 | 내보내기 | 대시보드 내보내기(PNG, PDF) | 선택 | - | - | 드롭다운, 버튼 |
| DV-007 | 편집 모드 | 대시보드 편집 모드 전환 | 클릭 | - | 소유자만 가능 | 버튼 |
...
| 기능 ID | 기능명 | 설명 | 입력 유형 | 기본값 | 제약조건 | UI 컴포넌트 |
|---------|--------|------|-----------|--------|----------|------------|
| CM-001 | 차트 유형 선택 | 생성할 차트 유형 선택 | 선택 | 시계열 차트 | - | 아이콘 그리드 |
| CM-002 | 차트 제목 설정 | 차트 제목 편집 | 텍스트 | "Untitled Chart" | 최대 100자 | 텍스트 필드 |
| CM-003 | 차트 설명 설정 | 차트 설명 편집 | 텍스트 | 빈 문자열 | 최대 200자 | 텍스트 영역 |
| CM-004 | 차트 저장 | 차트 설정 저장 | 클릭 | - | - | 버튼 |
| CM-005 | 차트 삭제 | 차트 삭제 | 클릭 | - | - | 버튼, 확인 대화상자 |
| CM-006 | 차트 복제 | 기존 차트 복제 | 클릭 | - | - | 버튼 |
| CM-007 | 차트 내보내기 | PNG, SVG, CSV 형식으로 내보내기 | 선택 | - | - | 드롭다운, 버튼 |
