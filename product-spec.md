...
- **공개 대시보드 둘러보기**: 다른 사용자가 공개한 대시보드 검색 및 조회
...
- **액션 버튼**:
  ...
  - **복사하기**: 내 계정으로 대시보드 포크 (타인 대시보드인 경우)
...
- **반응형 레이아웃**:
  - 데스크톱 (1200px+): 12 컬럼 그리드
  - 태블릿 (768px-1199px): 8 컬럼 그리드
  - 모바일 (767px 이하): 4 컬럼 그리드, 세로 스택 형태
