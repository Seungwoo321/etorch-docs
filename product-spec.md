...
- Basic 플랜 제한 도달 시 단계별 업그레이드 안내 경험
- 현재 사용량 vs Pro 혜택 비교를 통한 가치 인식
...
| 단계 | 전문가 목표 | 일반투자자 목표 | 측정 방법 |
|------|------------|----------------|-----------|
| 제한 도달 시 | 제한 안내 페이지 완독률 80% | 제한 안내 페이지 완독률 70% | 페이지 체류시간 |
| 안내 후 전환 | 7일 내 Pro 전환률 35% | 30일 내 Pro 전환률 15% | 결제 완료 추적 |
